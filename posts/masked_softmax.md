...
But, this is incorrect. Can you spot why?
...
The second uses the correct masking at the logit level by adding $-\infty$ to invalid logits. One trick is to note that $\texttt{False}$ can be interpreted as 0, and $\ln 0 = -\infty$:
